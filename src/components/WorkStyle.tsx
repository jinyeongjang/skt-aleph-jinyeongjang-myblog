  ...
  return (
    ...
    >
      <div className="space-y-1">
        ...
        <h2 className="text-2xl font-bold tracking-tight text-neutral-900 sm:text-3xl">작동 방식 & 설명서 ⚙️</h2>
        <p className="text-sm text-neutral-500">동료들과 최고의 시너지를 내기 위한 장진영 사용 설명서입니다.</p>
      </div>

      {/* 1. 저는 이런 사람입니다 (User Manual Highlight) */}
      <div className="rounded-2xl border border-neutral-200/90 bg-neutral-900 p-6 text-white shadow-xs sm:p-7">
        <div className="flex items-center gap-2.5 text-neutral-300">
          <Sparkles className="h-5 w-5 text-amber-400" />
          <h3 className="font-bold text-white">설명서 · 저는 이런 사람입니다</h3>
        </div>
        <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-3">
          <div className="rounded-xl bg-neutral-800/80 p-4">
            <h4 className="text-sm font-semibold text-amber-300">지식 공유자</h4>
            <p className="mt-1.5 text-xs leading-relaxed text-neutral-300 sm:text-sm">
              내가 배운 지식들을 다른 사람에게 알기 쉽게 전달해주는 것을 가장 좋아합니다.
            </p>
          </div>
          <div className="rounded-xl bg-neutral-800/80 p-4">
            <h4 className="text-sm font-semibold text-emerald-300">열린 소통</h4>
            <p className="mt-1.5 text-xs leading-relaxed text-neutral-300 sm:text-sm">
              언제든 편하게 말을 걸어주세요. 따뜻한 분위기 속에서 대화를 자연스럽게 이끌어갈 수 있습니다.
            </p>
          </div>
          <div className="rounded-xl bg-neutral-800/80 p-4">
            <h4 className="text-sm font-semibold text-sky-300">끈기 있는 메이커</h4>
            <p className="mt-1.5 text-xs leading-relaxed text-neutral-300 sm:text-sm">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        {/* 충전 / 몰입 */}
        <div className="rounded-2xl border border-emerald-200/80 bg-emerald-50/30 p-6 shadow-2xs">
        ...
        {/* 방전 & 주의사항 */}
        <div className="rounded-2xl border border-rose-200/80 bg-rose-50/30 p-6 shadow-2xs">
          ...
          <ul className="mt-4 space-y-2.5 text-xs leading-relaxed text-neutral-700 sm:text-sm">
            ...
            <li className="flex items-start gap-2">
              <span className="mt-1 font-bold text-rose-600">•</span>
              <span>
                <strong>조심해주세요:</strong> 대화할 때 간단한 맞장구나 피드백 등 반응을 남겨주시면 훨씬 힘이 납니다.
              </span>
            </li>
            <li className="flex items-start gap-2">
              <span className="mt-1 font-bold text-rose-600">•</span>
              <span>
                <strong>사전 공유:</strong> 협업 시 중요한 일정이나 변경 사항은 사전에 미리 공유해 주시면 차분히 준비할
                수 있습니다.
              </span>
            </li>
          </ul>
